...
class SetupTests(unittest.TestCase):
    def setUp(self):
        ...
        self.environment = dict(
            ...
            TEST_RUNNING="no", TEST_BUILD_EXIT="0", TEST_COMPOSE_EXIT="0",
        )
    ...
    def test_running_server_and_configuration_are_untouched(self):
        ...
        self.assertFalse(any(call.startswith(("compose build", "compose up", "run ")) for call in self.calls()))
    ...
    def test_existing_settings_reject_new_arguments(self):
        ...
        self.assertNotIn("compose build server", self.calls())
    ...
    def test_build_failure_does_not_start_server(self):
